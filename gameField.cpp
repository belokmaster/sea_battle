...
GameField::GameField(const GameField& other) : width(other.width), height(other.height), ships_count(other.ships_count) {
    field = new cell*[height];
...
void GameField::draw_enemy_field(ShipManager& manager) {
