...
OBJ = main.o field.o shipManager.o ship.o abilityManager.o abilities/ability.o abilities/bombard.o abilities/doubleDamage.o abilities/scanner.o game.o output.o input.o gameState.o workFile.o
